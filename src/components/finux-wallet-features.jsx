      ...
      <div className="mt-10 grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4">
        {items.map((item) => {
          ...
          return (
            <div
              key={item.title}
              className="group relative rounded-[28px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(0,0,0,0.12))] p-7 shadow-[0_26px_70px_rgba(0,0,0,0.45)] transition duration-300 hover:-translate-y-1 hover:scale-[1.01] hover:border-transparent hover:shadow-[0_30px_85px_rgba(0,0,0,0.55)]"
            >
              <div
              ...
              />
              <div className="grid h-12 w-12 place-items-center rounded-full border border-white/10 bg-black/20 text-[#f27f0d] transition duration-300 group-hover:border-[#f27f0d] group-hover:bg-[#f27f0d] group-hover:text-black">
